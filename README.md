...
install it (`pip install dublinBikes.tar.gz`), ensure that configuration file exists and
`DUBLINBIKES_SETTINGS` environment variable points to it, ensure that user has access to the
